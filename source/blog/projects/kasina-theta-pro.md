...
description: "Présentation de Kasina θ Pro, une application web progressive open-source pour générer des sessions audio-visuelles de méditation et d'entraînement cérébral."
app_link: /apps/kasina-pro/
...
👉 **[Kasina θ Pro - Demo](/apps/kasina-pro/)**

### Code Source

Le projet est **open-source** sous licence MIT :

👉 **[GitHub Repository](https://github.com/CyberMind-FR/kasina-pro)**
